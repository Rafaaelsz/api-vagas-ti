...
export const metadata: Metadata = {
  title: 'Vagas',
  description: 'Busque e filtre vagas de tecnologia por cargo, tecnologia, modalidade, senioridade, contrato e salário.',
};
  ...
  try {
    ...
    return (
      <section className="mx-auto grid max-w-7xl gap-6 px-4 py-10 sm:px-6 lg:px-8">
        <div>
          <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">Vagas de tecnologia</h1>
          <p className="mt-2 max-w-2xl text-muted-foreground">
            Filtre oportunidades publicadas pela API e encontre vagas com mais contexto antes de abrir os detalhes.
          </p>
        </div>
