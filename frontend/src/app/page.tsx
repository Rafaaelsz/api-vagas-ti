          ...
          <div className="max-w-3xl text-white">
            ...
            <form action="/vagas" className="mt-8 flex max-w-2xl flex-col gap-3 rounded-lg bg-white p-2 shadow-soft sm:flex-row">
              <div className="relative flex-1">
                ...
                <Input
                  name="search"
                  placeholder="Ex.: Node.js, React, Backend..."
                  className="h-12 border-0 pl-10 text-slate-950 placeholder:text-slate-500 selection:bg-primary/25 focus:ring-0 dark:text-white dark:placeholder:text-slate-400 dark:selection:bg-primary/35"
                />
              </div>
